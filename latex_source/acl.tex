...
\begin{enumerate}
	...
	\item email Sergiu, Sasha, Mircea to announce your team, your proposal and to discuss how to approach it
	...
	\item current deadline \textbf{December 12} mid-term; January 18 (to finalize most of the projects)
\end{enumerate}
...
\begin{enumerate}
	\item 25\% project complexity
    \item 25\% open-source code to reproduce the results
	\item 25\% the quality of this report in English using the current template 
